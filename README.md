...
The footer shows a build stamp — this package reads **Build 5 · grouped grocery
list**. If the footer shows nothing or an older build, the new `js/app.js` did
...
The CSS and JS are linked with `?v=5` so browsers cannot serve a stale cached
