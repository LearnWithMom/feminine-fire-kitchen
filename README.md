...
100 recipes, a 30-day planner, and grocery lists — all running in the browser, no server needed.
...
This edition uses 100 recipes. Each recipe now includes:
...
## Final instruction and navigation audit
- All 100 recipes were reviewed for complete cook-through instructions.
- Do This now includes heat level, ingredient use, timing, and doneness guidance instead of shorthand notes.
- Search and filters show a live result count and a visible description of the active filter.
- Category chips provide quick browsing by Chicken, Beef, Seafood, Crockpot, Instant Pot, Breakfast, and Sides.
- Clear Filters stays visible in the recipe section.
- A sticky quick-navigation bar jumps directly to Plan, Recipes, Groceries, Prep, or Top.
